...
export class ShiprocketProvider implements ShippingProvider {
  ...
  async getServiceability(
    ...
    try {
      ...
      const rate = parseFloat(String(bestCourier.freight_charge || bestCourier.rate || 0));
      ...
      return [{
        ...
        courierName: String(bestCourier.courier_name || 'Unknown Courier'),
